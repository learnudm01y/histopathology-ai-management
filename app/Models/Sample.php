...
class Sample extends Model
{
    protected $fillable = [
        ...
        'category_id', 'disease_subtype_id', 'stain_id', 'stain_marker', 'disease_subtype', 'tissue_name', 'training_phase',
    ...
    /**
     * Fine-grained ("exact disease name") leaf class.
     * The parent taxonomy level is reachable via $sample->diseaseSubtype->category.
     */
    public function diseaseSubtype(): BelongsTo
    {
        return $this->belongsTo(DiseaseSubtype::class);
    }
